...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String easyUIHome = basePath+"/easyui-1.3.2";
      ...
      out.write("<body>\r\n");
      out.write("\r\n");
      out.write("\t<input type=\"button\" id=\"login\" value=\"登 录\"/>\r\n");
      out.write("\t<script type=\"text/javascript\">\r\n");
      out.write("\t$(function(){\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#login\").bind(\"click\",login);\r\n");
      out.write("\t});\r\n");
      ...
      out.write("\t\t\ttype:\"post\",\r\n");
      out.write("\t\t\tdata:{\r\n");
      out.write("\t\t\t\t'username':\"张少举\",\r\n");
      out.write("\t\t\t\t'password':\"aimuchun99\"\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\tsuccess:function(data){\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t//data = eval(\"\\\"\"+data+\"\\\"\");\r\n");
      out.write("\t\t\t\tif(data && data.msg == \"success\"){\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t$.messager.alert(\"木屋消息\",\"登录   成功\",\"info\");\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t}else if(data.msg == \"fail\"){\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t$.messager.alert(\"木屋消息\",\"登录失败\",\"info\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
